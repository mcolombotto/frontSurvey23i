          ...
          <div className="col-md-12 col-lg-6">
            <div className="mt-4">
              ...
              <p className="letter-first space-letter">
                WorldSurveys es una empresa de gestión de experiencias ágil
                creada para lo que viene. Brindamos soluciones intuitivas y
                centradas en las personas que ayudan a los líderes de la
                industria a tomar decisiones importantes, actuar y lograr
                resultados tangibles de manera rápida y segura. Nuestra
                plataforma impulsada por IA está construida con un equilibrio
                intencionado de humanidad y tecnología, uniendo más de 20 años
                de experiencia con datos derivados de miles de millones de
                preguntas y respuestas reales. En la actualidad, ofrecemos
                soluciones empresariales para la gestión ágil de la experiencia
                y los conocimientos de nuestras marcas de productos.
              </p>
            </div>
          </div>
          ...
          <div className="d-flex flex-lg-row-reverse flex-md-column">
            <div className="col-md-12 col-lg-6">
              <div className="mt-4">
                ...
                <p className="letter-first space-letter">
                  Nuestra visión, misión y valores reflejan los mejores
                  intereses de nuestros clientes, empleados y comunidad. Ellos
                  inspiran nuestro crecimiento. Ayudan a dar forma a nuestras
                  decisiones comerciales, definen nuestra cultura y miden
                  nuestro éxito. A través de nuestras elecciones, palabras y
                  acciones, nos esforzamos por vivir nuestros valores todos los
                  días.
                </p>
              </div>
            </div>
