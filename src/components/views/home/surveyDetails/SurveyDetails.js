  ...
  return (
    <Container>
      ...
      <div className="text-light d-flex align-items-center justify-content-between">
        ...
        <p className="my-4 fs-4"> Categoría de encuesta : {survey.category}</p>
      </div>
      ...
      <ListGroup>
        <ListGroupItem className="text-light fw-bold">
          Por ultimo, dejenos su correo para que las respuestas se envíen y
          pueda guardar un registro de ellas. (Opcional)
