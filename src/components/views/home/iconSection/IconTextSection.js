    ...
    <div className="icon-text-section">
      <div className="icon-container">
        ...
        <div className="text-container">
          <p>
            El encuestado puede responder las encuestas de manera anónima o
            ingresando un email.
          </p>
        </div>
      </div>
      ...
      <div className="icon-container">
        ...
        <div className="text-container">
          <p>
            Permite al encuestado recibir las respuestas ingresadas en su
            correo.
          </p>
        </div>
      </div>
      ...
      <div className="icon-container">
        ...
        <div className="text-container">
          <p>
            Crea categorías que permitan buscar las encuestas de manera más
            organizada.
          </p>
        </div>
      </div>
